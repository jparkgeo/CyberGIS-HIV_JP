...
def Scenario_Analysis(param, excludeOutliers):
    ...
    print(f"Model Results (XLSX): {local_dir3 + 'SAM_' + param['filename_suffix']+'/data/' + param['filename_suffix']+'_output.xlsx'}")
...
def Display_GUI():    
    ...
    optional = VBox([
        ...
        VBox([HBox([Label(value='Number of PCP(s)', layout=Layout(width="300px")), Text(value="15")]),
